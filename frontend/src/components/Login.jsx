...
const Login = () => {
  const { login, devMode, user } = useAuth();
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <p className="text-gray-300 text-center mb-8">
          {devMode
            ? "Development mode: Sign in to participate in voting and submit suggestions."
            : "Sign in with Discord to participate in voting and submit suggestions."
          }
        </p>
